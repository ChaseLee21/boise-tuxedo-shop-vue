<template>
    ...
    <main class="xl:w-[80vw] xl:flex xl:flex-col xl:m-auto mx-2">
        <section>
            <article>
                ...
                <ul class="list-inside list-disc">
                    <li>5 Piece: Coat, pants, shirt, vest, and tie (no shoes included)  --- <span class="font-bold">Starting at $149</span></li>
                    <li>6 Piece: Coat, pants, shirt, vest, tie, and shoes --- <span class="font-bold">Starting at $165</span></li>
        ...
        <section>
            ...
            <div class="px-2">
                <article>
                    <h3 class="text-2xl text-red-600 font-bold">How soon do I need to reserve my tuxedo or suit?</h3>
                ...
                <article>
                    ...
                    <p class="indent-3 text-lg">Prom is on Saturday you will pick it up on Thursday or Friday and return it no later than Monday.</p>
                </article>
                <!-- <article>
